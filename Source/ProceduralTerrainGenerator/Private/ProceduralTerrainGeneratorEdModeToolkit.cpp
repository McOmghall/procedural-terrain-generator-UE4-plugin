...
FName FProceduralTerrainGeneratorEdModeToolkit::GetToolkitFName() const
{
	return FName("ProceduralTerrainGeneratorEdMode");
}

FText FProceduralTerrainGeneratorEdModeToolkit::GetBaseToolkitName() const
{
	return NSLOCTEXT("ProceduralTerrainGeneratorEdModeToolkit", "DisplayName", "ProceduralTerrainGeneratorEdMode Tool");
}

class FEdMode* FProceduralTerrainGeneratorEdModeToolkit::GetEditorMode() const
{
